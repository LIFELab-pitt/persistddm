...
blocksequences{1}   = [10 10]; % length needs to be even number! 
blocksequences{2}   = [10 10]; % length needs to be even number! 
...
if runTask
    ...
    prep.cue{1} = fullfile(prep.dir.imgs,'Win_slot1_up.jpg'); % burlesque
    prep.cue{2} = fullfile(prep.dir.imgs,'Win_slot2_up.jpg'); % vanilla
    prep.cue{3} = fullfile(prep.dir.imgs,'Win_slot1_down.jpg'); % burlesque
    prep.cue{4} = fullfile(prep.dir.imgs,'Win_slot2_down.jpg'); % vanilla
    prep.cue{5} = fullfile(prep.dir.imgs,'Lose_slot1_up.jpg'); % dark blue
    prep.cue{6} = fullfile(prep.dir.imgs,'Lose_slot2_up.jpg'); % pink
    prep.cue{7} = fullfile(prep.dir.imgs,'Lose_slot1_down.jpg'); % dark blue
    prep.cue{8} = fullfile(prep.dir.imgs,'Lose_slot2_down.jpg'); % pink
