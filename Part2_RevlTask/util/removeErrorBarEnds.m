function removeErrorBarEnds(he)
%removeErrorBarEnds
% removeErrorBarEnds(he) removes the lines above/below errorbars
% generated by the matlab function he = errorbar()
%
% Example:
% x = 1:10;
% y = sin(x);
...
dataLen = length( get(he, 'xdata') );

%objects to try, one of this is the errorbars
candidateList = findall(he);
